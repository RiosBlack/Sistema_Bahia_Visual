...
export default function SystemPage() {
	return (
		<div className="flex w-full h-full items-center justify-center">
			<div className="w-1/2 h-full grid justify-items-center content-center">
				<video autoPlay loop muted about="video background" className="h-full relative rounded-3xl overflow-hidden" >
